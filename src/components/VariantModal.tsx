  ...
  return (
    <>
      ...
      <Modal
        ...
        className="absolute top-[5%] left-[50%] max-h-[90vh] w-[90vw] -translate-x-1/2 overflow-auto px-[1.6875rem] pb-14 pt-12 outline-none sm:w-[31.25rem] md:w-[40rem] lg:w-[50rem]"
